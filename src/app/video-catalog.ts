...
export const VIDEO_CATALOG: VideoAsset[] = [
  {
    ...
    thumbUri: resolveAssetPath('/assets/videos/pexels-koolshooters-6975806.png'),
  ...
  },
  {
    ...
    thumbUri: resolveAssetPath('/assets/videos/pexels-nicola-barts-7930811.png'),
  ...
  {
    full: resolveAssetPath('/assets/videos/pexels-tima-miroshnichenko-7033913.mp4'),
    thumbUri: resolveAssetPath('/assets/videos/pexels-tima-miroshnichenko-7033913.png'),
